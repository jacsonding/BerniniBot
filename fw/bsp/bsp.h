...
typedef enum
{
    ...
    BSP_EVENT_KEY_0_RELEASE,                        /**< Default event of the release action of BSP_BUTTON_0 (only if this button is present). */
    BSP_EVENT_KEY_1_RELEASE,                        /**< Default event of the release action of BSP_BUTTON_1 (only if this button is present). */
    BSP_EVENT_KEY_2_RELEASE,                        /**< Default event of the release action of BSP_BUTTON_2 (only if this button is present). */
    BSP_EVENT_KEY_3_RELEASE,                        /**< Default event of the release action of BSP_BUTTON_3 (only if this button is present). */
